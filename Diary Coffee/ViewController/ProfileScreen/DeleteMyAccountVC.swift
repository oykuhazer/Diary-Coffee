...
class DeleteMyAccountVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.title = NSLocalizedString("delete_my_account", comment: "")
    ...
    private func setupUI() {
        ...
        descriptionLabel.text = NSLocalizedString("delete_my_account_description", comment: "")
        ...
        deleteButton.setTitle(NSLocalizedString("delete_my_account", comment: ""), for: .normal)
    ...
    @objc private func deleteAccount() {
        ...
        self.indicatorView.show()
            ...
            DeleteUserProfileRequest.shared.deleteUserProfile(uuid: userId) { result in
                DispatchQueue.main.async {
                    ...
                    case .success(let response):
                        ...
                        if response.resultCode == 200 {
                            UserProfile.shared.resetProfile()
                            let onboardingInfoVC = OnboardingIntroVC()
