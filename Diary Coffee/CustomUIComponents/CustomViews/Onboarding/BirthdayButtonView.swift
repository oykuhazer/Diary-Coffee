...
class BirthdayButtonView: UIView {
    ...
    private func setupView() {
        ...
        self.backgroundColor = AppColors.color4
        self.layer.cornerRadius = 10

        button.translatesAutoresizingMaskIntoConstraints = false
        button.setTitle(NSLocalizedString("select_your_birthday", comment: "") + " 🎂", for: .normal)
    ...
    func updateButtonTitle(with date: Date) {
        ...
        button.layer.backgroundColor = AppColors.color3.cgColor
